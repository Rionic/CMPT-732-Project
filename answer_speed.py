...
def calc_answer_speed(input_q, input_a, output):
    ...
    # Write Results
    avg_answer_speed.write.mode('overwrite').parquet(f'{output}/answer-speed')
...
if __name__ == '__main__':
    ...
    calc_answer_speed(input_path_tag_questions, input_path_answers, output)
